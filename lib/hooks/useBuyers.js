...
export const useBuyers = (params = {}, options = {}) => {
  // Default to only fetch active buyers with increased limit
  const queryParams = { isActive: true, limit: 500, ...params };
  ...
  return useQuery({
    ...
    select: (response) => {
      ...
      console.log(`useBuyers: Filtered to ${activeBuyers.length} active buyers (filtered ${buyers.length - activeBuyers.length} inactive)`);
  ...
  return useQuery({
    ...
    select: (response) => {
      ...
      return {
        ...
        phoneAreaCode: rawBuyer.phoneAreaCode || '',
        alternatePhone: rawBuyer.alternatePhone || '',
        alternatePhoneAreaCode: rawBuyer.alternatePhoneAreaCode || '',
