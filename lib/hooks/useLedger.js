...
export function useAllLogisticsLedgers(params = {}) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      // Debug logging
      console.log('useAllLogisticsLedgers - params:', params);
      console.log('useAllLogisticsLedgers - response:', response);
      console.log('useAllLogisticsLedgers - backendResponse:', backendResponse);
      console.log('useAllLogisticsLedgers - ledgerData:', ledgerData);
      console.log('useAllLogisticsLedgers - entries:', ledgerData?.entries);
