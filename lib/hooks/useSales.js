  ...
  return useQuery({
    ...
    select: (response) => {
      ...
      return sales.data.map(sale => ({
        ...
        companyName: sale.buyer?.company || sale.manualCustomer?.company || '—',
        total: sale.grandTotal || sale.subtotal || 0,
        cash: sale.cashPayment || sale.paidAmount || 0,
        bankCash: sale.bankPayment || 0,
        discount: sale.totalDiscount || 0,
        balance: (sale.grandTotal || 0) - (sale.cashPayment) - (sale.bankPayment),
        paymentMethod: sale.paymentMethod,
        paymentStatus: sale.paymentStatus,
        saleType: sale.saleType,
        deliveryStatus: sale.deliveryStatus,
        // Include items for product display in the table
        items: sale.items || [],
