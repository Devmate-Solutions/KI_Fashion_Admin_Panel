...
export const useInventoryList = (params = {}) => {
  const queryParams = {
    ...
    searchSupplier: params.searchSupplier || undefined,
    searchProduct: params.searchProduct || undefined,
    searchSku: params.searchSku || undefined,
    ...
    minStock: params.minStock !== undefined ? String(params.minStock) : undefined,
    maxStock: params.maxStock !== undefined ? String(params.maxStock) : undefined,
    minCost: params.minCost !== undefined ? String(params.minCost) : undefined,
    maxCost: params.maxCost !== undefined ? String(params.maxCost) : undefined,
  ...
  return useQuery({
    ...
    staleTime: 120 * 1000,
    gcTime: 5 * 60 * 1000,
    refetchInterval: false, // Disabled polling as requested
    select: (response) => {
