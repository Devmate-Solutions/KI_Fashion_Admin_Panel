  ...
  return useQuery({
    ...
    select: (response) => {
      ...
      return users.map(user => ({
        ...
        company: user.supplier?.company || user.buyer?.company || user.company,
        ...
        alternatePhoneAreaCode: user.alternatePhoneAreaCode,
...
export const useRegisterUser = () => {
  ...
  return useMutation({
    mutationFn: (userData) => usersAPI.register(userData),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: usersKeys.lists() });
