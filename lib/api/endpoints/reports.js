...
// Get dashboard top stats
  getDashboardTopStats: async (params) => {
    const result = await apiClient.get('/reports/dashboard/top-stats', { params });
    return result;
  },
  ...
  getStockSummaryReport: async (params) => {
    const result = await apiClient.get('/reports/stock-summary', { params });
    return result;
  },
  ...
  // Cash in Hand Report
  getCashInHandReport: async (params) => {
    const result = await apiClient.get('/reports/cash-in-hand', { params });
    return result;
  },

  // Sales Returns Product-wise Report
  getSalesReturnsProductWiseReport: async (params) => {
    const result = await apiClient.get('/reports/sales-returns-product-wise', { params });
    return result;
  },

  // Buying Returns Product-wise Report
  getBuyingReturnsProductWiseReport: async (params) => {
    const result = await apiClient.get('/reports/buying-returns-product-wise', { params });
    return result;
  },

  // Product Summary Report
  getProductSummaryReport: async (params) => {
    const result = await apiClient.get('/reports/product-summary', { params });
    return result;
  },

  // Product History Report
  getProductHistoryReport: async (params) => {
    const result = await apiClient.get('/reports/product-history', { params });
    return result;
  },

  // Month-End Detailed Report
  getMonthEndDetailedReport: async (params) => {
    const result = await apiClient.get('/reports/month-end-detailed', { params });
    return result;
  },
};
