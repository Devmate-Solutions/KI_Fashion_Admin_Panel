      ...
      <div className="flex items-center justify-between border-b pb-4 border-slate-100">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-slate-500 font-mono uppercase tracking-widest">{id}</p>
          </div>
        </div>

        <div className="flex items-center gap-3">
             <div className="flex flex-col items-end gap-1">
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Operation</span>
                <Badge variant="outline" className={`px-3 py-0.5 text-[10px] font-bold rounded-none border uppercase tracking-wider ${ACTION_COLORS[log.action] || "bg-slate-100 text-slate-800 border-slate-200"}`}>
                    {log.action}
                </Badge>
             </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 items-start">
        ...
        <div className="lg:col-span-1 space-y-4">
            <div className="bg-white p-5 border border-slate-200 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col border-t pt-3 border-slate-50">
        ...
        <div className="lg:col-span-3 space-y-4">
            ...
            <section className="bg-white p-6 border border-slate-200 shadow-sm">
                ...
                <div className="bg-slate-50/50 p-4 border-l-2 border-l-blue-600 border border-slate-100">
